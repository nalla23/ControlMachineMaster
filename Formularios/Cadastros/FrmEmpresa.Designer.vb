...
Partial Class FrmEmpresa
    ...
    Private Sub InitializeComponent()
        ...
        GroupBox1.Controls.Add(Tmotivo)
        GroupBox1.Controls.Add(LSit)
        ...
        Button1.Location = New Point(351, 22)
        ...
        Label19.Location = New Point(540, 32)
        ...
        TCodigo.Location = New Point(578, 26)
        TCodigo.MaxLength = 15
        TCodigo.Name = "TCodigo"
        TCodigo.Size = New Size(60, 27)
        TCodigo.TabIndex = 42
        ' 
        ' Label18
        ' 
        Label18.AutoSize = True
        Label18.Location = New Point(655, 232)
        ...
        ' 
        LSit.AutoSize = True
        LSit.Location = New Point(650, 205)
        LSit.Name = "LSit"
        ...
        Label15.Location = New Point(435, 232)
        ...
        DtCad.Location = New Point(527, 225)
        DtCad.MinDate = New DateTime(1990, 1, 1, 0, 0, 0, 0)
        DtCad.Name = "DtCad"
        DtCad.Size = New Size(111, 27)
        DtCad.TabIndex = 16
        ' 
        ' TCel
        ' 
        ...
        TFone.InsertKeyMode = InsertKeyMode.Overwrite
        TFone.Location = New Point(83, 192)
        TFone.Mask = "(##)####-####"
        TFone.Name = "TFone"
        TFone.Size = New Size(108, 27)
        TFone.TabIndex = 12
        TFone.TextMaskFormat = MaskFormat.ExcludePromptAndLiterals
        ' 
        ' TCep
        ' 
        ...
        Tdoc.Name = "Tdoc"
        Tdoc.Size = New Size(149, 27)
        Tdoc.TabIndex = 2
        ' 
        ' PictureBox1
        ' 
        PictureBox1.Image = CType(resources.GetObject("PictureBox1.Image"), Image)
        PictureBox1.Location = New Point(650, 22)
        ...
        Tnumero.Location = New Point(527, 125)
        Tnumero.MaxLength = 30
        Tnumero.Name = "Tnumero"
        Tnumero.Size = New Size(111, 27)
        Tnumero.TabIndex = 8
        ' 
        ' Label6
        ' 
        ...
        TEnde.Location = New Point(225, 125)
        TEnde.MaxLength = 30
        TEnde.Name = "TEnde"
        TEnde.Size = New Size(236, 27)
        TEnde.TabIndex = 7
        ' 
        ' Label5
        ' 
        ...
        TReg.Location = New Point(420, 26)
        TReg.MaxLength = 15
        TReg.Name = "TReg"
        TReg.Size = New Size(114, 27)
        TReg.TabIndex = 3
        ' 
        ' Label3
        ' 
        ...
        BtFechar.Location = New Point(246, 0)
    ...
    Friend WithEvents LSit As Label
